...
| More than **65,535 variable-length elements** in one dataset or attribute (`FormatError::GlobalHeapObjectLimitExceeded`) | [#187](https://github.com/stephenberry/hdf5-pure/pull/187) |
